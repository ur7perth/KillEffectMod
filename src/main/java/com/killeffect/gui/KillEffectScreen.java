...
public class KillEffectScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        // Plain dark overlay - deliberately NOT calling renderBackground(), which on
        // recent Minecraft versions applies a background blur shader depending on the
        // player's "Menu Background Blurriness" setting. This keeps our GUI crisp for
        // everyone regardless of that setting.
